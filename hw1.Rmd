...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Jack Novak** and I'm a junior at ISU. I major in *Economics* and *Statistics* with minors in Spanish and Data Science. After I graduate, I want to pursue a master's in applied economics and work as an economist.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: Economists increasingly rely on data science to make sense of big data. In my office at USDA, my coworkers rely on SQL, Python, and Socrata to store, process, and communicate massive transportation datasets. This is evident at my offices open data platform, <https://agtransport.usda.gov/>.
    
    ![Our website includes interactive graphics such as this stacked bar chart which shows grain shipments by transportation mode.](C:\Users\HP\Documents\DS 202\ds202_hw1\modal_share_image.png)
  
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I'm most interested in economic and political data. These data often come from government sources, such as Bureau of Labor Statistics or the open data platform that I linked above. For political data, though, I also follow <https://data.fivethirtyeight.com/>.
